...
function workscout_custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'sections'        => array(
      array(
        'id'          => 'home',
        'title'       => esc_html__( 'Home Page', 'workscout' )
      ),
      array(
    ...
    'settings'        => array(
        ...
        array(
            'label'       => 'Login/Sing Up form in lightbox',
            'id'          => 'pp_login_form',
            'type'        => 'on_off',
            'desc'        => 'If set to "Off" login/sign up box will show up on separate page',
            'std'         => 'off',
            'rows'        => '',
            'post_type'   => '',
            'taxonomy'    => '',
        ...
        array(
          'id'          => 'pp_jobs_search_bg',
          'label'       => 'Background for search banner on homepage',
          'std'         => '',
          'type'        => 'background',
          'section'     => 'home',
          'rows'        => '',
        ...
        array(
            'label'       => 'Choose "Sign Up/Register" page',
            'id'          => 'pp_login_page',
            'type'        => 'page_select',
            'desc'        => 'This page needs to use template named "Page Template Login"',
            'std'         => '',
            'rows'        => '',
            'post_type'   => '',
            'taxonomy'    => '',
        ...
        array(
            'label'       => 'Choose "Browse Categories Page"',
            'id'          => 'pp_categories_page',
            'type'        => 'page_select',
            'desc'        => 'This page needs to use template named "Job Categories Page Template"',
            'std'         => '',
            'rows'        => '',
            'post_type'   => '',
            'taxonomy'    => '',
        ...
        array(
            'id'          => 'pp-fonts',
            'label'       => esc_html__( 'Google Fonts', 'workscout' ),
            'desc'        => '',
            'std'         => array( 
                array(
                    'family'    => 'montserrat',
