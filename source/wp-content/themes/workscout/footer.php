	...
	<div class="container">
		<div class="footer-bottom">
			<div class="sixteen columns">
				...
				<div class="copyrights"><?php $copyrights = "&copy;".Kirki::get_option( 'workscout', 'pp_copyrights' ); 
            ...
            markers: [
                ...
                if(!empty($markers)) {
                    foreach ($markers as $marker) { ?>
                    {
                        ...
                        html: '<strong style="font-size: 14px;"><?php echo esc_js($marker['title']); ?></strong></br><?php echo esc_js($marker['content']); ?>',
                        popup: true,
                    },
                    <?php }
                } ?>
